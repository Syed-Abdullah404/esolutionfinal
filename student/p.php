                     ...
                     <div class="col-lg-12">
                        <table id="example" class="table table-striped table-responsive mx-10">
                           ...
                           <tbody>
                             <?php
                             $id=$_GET['id'];
                                $select=mysqli_query($conn,"select * from student_project where stu_id='$id'");
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="xtra_p.php?idp=<?php echo $row['id']; ?>" class="btn btn-success btn-sm">
                                              Add Files
                                       </a>
                                    </td>
                                    <td>
                                    <a href="view_project_files.php?idv=<?php echo $id; ?>" class="btn btn-success btn-sm ">
                                              View Files
                                       </a>
                                    </td>
                     ...
                     <form method="POST" >
                        <div class="form-group">
                           <table class="table table-striped">
                              ...
                              $t_id=$_GET['id'];
                              echo $t_id;
                                $sql=mysqli_query($conn,"select * from teacher_quiz_response where quiz_id='$id'");
...
<?php 
   ...
   if(isset($_POST['add'])){
     ...
     $description=$_POST['description'];
      $id_head=$_GET['id'];
     $sql=mysqli_query($conn,"INSERT INTO `student_project`(`stu_id`, `name`, `description`) VALUES ('$id_head','$name','$description')");
...
if(isset($_POST['edit'])){
   ...
   $sql=mysqli_query($conn,"UPDATE `student_project` SET `name`='$name',`description`='$description' WHERE id='$id'");

      if($sql){

      ?>
         <script>
            window.location="<?php echo $app_url .'student/p.php?id='."$id_head" ?>";
         </script>
      <?php
      }
