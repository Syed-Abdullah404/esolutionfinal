                        ...
                        <div class="modal-dialog">
                           <div class="modal-content">
                              <div class="modal-header bg-light">
                                 <h4 class="modal-title " id="exampleModalLabel">Add Assignment</h4>
                     ...
                     <div class="col-lg-12">
                        <table id="example" class="table table-striped table-responsive mx-10">
                           ...
                           <tbody>
                              ...
                              ?>
                                 <tr>
                                    <td><?php echo $id_assignment; ?></td>
                                    <td><?php echo $row['name']; ?></td>
                                    <td style="width:600px;"><?php echo $row['description']; ?></td>
                                    <td>
                                       <a href="<?php echo $app_url.'student/xtra_assignment.php?id='.$id; ?>" class="btn btn-success btn-sm ">
                                          Add Files
                                       </a>

                                    </td>
                                    <td>
                                       <a href="view_assignemnt_files.php?idv=<?php echo $row['id']; ?>" class="btn btn-success btn-sm ">
                                          View Files
                                       </a>
                                    </td>
...
if (isset($_POST['add'])) {
   ...
   $id_head = $_GET['id'];
   $sql = mysqli_query($conn, "INSERT INTO `student_assignment`( `stu_id`,`name`, `description`) VALUES ('$id_head','$name','$description')");

   if ($sql) {

?>
      <script>
         window.location = "<?php echo $app_url . 'student/assignment.php?id=' . "$id_head" ?>";
      </script>
   <?php
   }
}
...
if (isset($_POST['edit'])) {
   ...
   $id_head = $_GET['id'];
   $sql = mysqli_query($conn, "UPDATE `student_assignment` SET `name`='$name',`description`='$description' WHERE id='$id'");
