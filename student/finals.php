               ...
               <div class="row">
                  ...
                  <div class="col-lg-3">
                     <button type="button" id="button-addon2" data-bs-toggle="modal" data-bs-target="#exampleModal" class="btn btn-lg float-right mb-3" >
                        <i class="fas fa-plus"></i>  Add Final
                     </button>
                     <!--Modal-->
                        ...
                        <div class="modal-dialog">
                           <div class="modal-content">
                              <div class="modal-header bg-light">
                                 <h4 class="modal-title " id="exampleModalLabel">Add Final</h4>
                  ...
                  <div class="row">
                     <div class="col-lg-12">
                        <table id="example" class="table table-striped table-responsive mx-10">
                           ...
                           <?php
                             $id=$_SESSION['id'];
                                $select=mysqli_query($conn,"select * from student_finals where stu_id='$id'");
                                $i=1;
                                ...
                                <tr>
                                    ...
                                    <td>
                                    <a href="xtra_final.php" class="btn btn-success btn-sm editbtn">
                                              Add Files
                                       </a>
                                    </td>
                                    <td>
                                    <a href="view_finals_files.php" class="btn btn-success btn-sm ">
                                              View Files
                                       </a>
                                    </td>
   ...
   <div class="modal-dialog">
      <div class="modal-content">
         <div class="modal-header">
            <h5 class="modal-title" id="exampleModalLabel">Edit Final</h5>
            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
         </div>
         <div class="modal-body">
         <form method="POST" enctype="multipart/form-data">
...
<?php 
   ...
   if(isset($_POST['add'])){
    ...
    $description=$_POST['description'];
     ...
     $id_head=$_GET['id'];
    $sql=mysqli_query($conn,"INSERT INTO `student_finals`(`stu_id`, `name`, `description`) VALUES ('$id_head','$name','$description')");
    
    if($sql){
    
      ?>
         <script>
           window.location="<?php echo $app_url .'student/finals.php?id='."$id_head" ?>";
         </script>
      <?php
 ...
 if(isset($_POST['edit'])){
  ...
  $description=$_POST['description'];
   ...
   $id_head=$_GET['id'];
   $sql=mysqli_query($conn,"UPDATE `student_finals` SET `name`='$name',`description`='$description' WHERE id='$id'");
