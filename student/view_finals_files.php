...
include '../connection.php';
   ...
   define("TITLE","Teacher Finals Response");
   define("PAGE","Teacher Finals Response");
   ...
   <div class="container">
      <div class="card">
         <div class="card-header border-0">
            <h3 class="card-title display-6">Teacher Finals Response</h3>
            <hr>
                     ...
                     <div class="col-lg-12">
                        <table id="example" class="table table-striped table-responsive mx-10">
                           ...
                           <tbody>
                                   ...
                                   <?php
                                        $idquiz=$_GET['idv'];
                                        $quiz_sel=mysqli_query($conn,"select * from teacher_final_response where final_id='$idquiz' ");
