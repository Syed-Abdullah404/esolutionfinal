...
include '../connection.php';
   ...
   define("TITLE","Lab Work");
   define("PAGE","Lab Work");
   ...
   <div class="container">
      <div class="card">
         <div class="card-header border-0">
            <h3 class="card-title display-6">Lab Work</h3>
            <hr>
                        ...
                        <div class="modal-dialog">
                           <div class="modal-content">
                              <div class="modal-header bg-light">
                                 <h4 class="modal-title " id="exampleModalLabel">Add Lab Work</h4>
                     ...
                     <div class="col-lg-12">
                        <table id="example" class="table table-striped table-responsive mx-10">
                           ...
                           <tbody>
                             <?php
                              $id=$_GET['id'];
                                $select=mysqli_query($conn,"select * from student_lab where stu_id='$id'");
                                $i=1;
                                ...
                                <tr>
                                    ...
                                    <td>
                                    <a href="xtra_lab.php?idlb=<?php echo $row['id']; ?>" class="btn btn-success btn-sm editbtn">
                                              Add Files
                                       </a>
                                    </td>
                                    <td>
                                    <a href="view_lab_files.php?idv=<?php echo $row['id'];  ?>" class="btn btn-success btn-sm ">
                                              View Files
                                       </a>
                                    </td>
                                    <td class="text-center">
                                        <div class="action">
                                          ...
                                          <li class="dropdown-item editbtn">   
   ...
   <div class="modal-dialog">
      <div class="modal-content">
         <div class="modal-header">
            <h5 class="modal-title" id="exampleModalLabel">Edit Lab Work</h5>
            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
         </div>
         <div class="modal-body">
         <form method="POST">
...
<?php 
   ...
   if(isset($_POST['add'])){
      ...
      $description=$_POST['description'];
       $id_head=$_GET['id'];
      $sql=mysqli_query($conn,"INSERT INTO `student_lab`(`stu_id`, `name`, `description`) VALUES ('$id_head','$name','$description')");
      
      if($sql){     
     
        ?>
           <script>
             window.location="<?php echo $app_url .'student/lab.php?id='."$id_head" ?>";
           </script>
        <?php
...
;
   ...
   $id_head=$_GET['id'];
   $sql=mysqli_query($conn,"UPDATE `student_lab` SET `name`='$name',`description`='$description' WHERE id='$id'");

      if($sql){

      ?>
         <script>
            window.location="<?php echo $app_url .'student/lab.php?idlb='."$id_head" ?>";
         </script>
      <?php
      }
