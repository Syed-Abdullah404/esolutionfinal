   ...
   <div class="container">
      <div class="card">
         <div class="card-header border-0">
            <h3 class="card-title display-6">Mid</h3>
            <hr>
                     ...
                     <div class="col-lg-12">
                        <table id="example" class="table table-striped table-responsive mx-10">
                           ...
                           <tbody>
                                   ...
                                   <?php
                                        $idmuiz=$_SESSION['id'];
                                        $quiz_sel=mysqli_query($conn,"select * from student_xtra_mid where mid_id='$idmuiz'");
                                        if($quiz_sel){
   ...
   include 'footer.php';
    ...
    if(isset($_POST['addFile'])){
      ...
      if($file_error == 0){
       ...
       $id_head=$_SESSION['id'];
       $id_mid=$_SESSION['id'];
       $sqli=mysqli_query($conn,"INSERT INTO `student_xtra_mid`(`stu_id`, `mid_id`, `course`, `name`, `description`, `stu_file`, `start_time`, `end_time`, `start_date`, `end_date`,`date`) VALUES ('$id_head','$id_mid','$course','$name_quiz','$decri','$destinaton','$stime','$etime','$sdate','$edate',NOW())");
       if($sqli){
