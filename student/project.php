                           ...
                           <?php
                              $id=$_SESSION['id'];
                                ...
                                <tr>
                                    ...
                                    <td>
                                    <a href="xtra_project.php" class="btn btn-success btn-sm editbtn">
                                              Add Files
                                       </a>
                                    </td>
                                    <td>
                                    <a href="view_project_files.php" class="btn btn-success btn-sm ">
                                              View Files
                                       </a>
                                    </td>
...
<?php 
   ...
   if(isset($_POST['add'])){
    ...
    if($sql){
      ...
      ?>
         <script>
           window.location="<?php echo $app_url .'student/project.php?id='."$id_head" ?>";
         </script>
      <?php
    }
...
if(isset($_POST['edit'])){
   ...
   $sql=mysqli_query($conn,"UPDATE `student_project` SET `name`='$name',`description`='$description' WHERE id='$id'");
      ...
      ?>
         <script>
            window.location="<?php echo $app_url .'student/project.php?idp='."$id_head" ?>";
         </script>
      <?php
      }
