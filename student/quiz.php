                     ...
                     <div class="col-lg-12">
                        <table id="example" class="table table-striped table-responsive mx-10">
                           ...
                           <tbody>
                             <?php
                             $idget=$_GET['id'];
                                $select=mysqli_query($conn,"select * from studen_quiz where stu_id=".$id);
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="xtra_quiz.php?id=<?php echo $idget;?>" class="btn btn-success btn-sm">
                                              Add Files
                                       </a>
                                    </td>
                                    <td>
                                    <a href="view_quiz_files.php?idv=<?php echo $id; ?>" class="btn btn-success btn-sm ">
                                              View Files
                                       </a>
                                    </td>
