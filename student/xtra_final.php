   ...
   <div class="container">
      <div class="card">
         <div class="card-header border-0">
            <h3 class="card-title display-6">Finals</h3>
            <hr>
            <div class="container mt-1">
               ...
               <div class="row">
                  ...
                  <div class="col-lg-3">
                     ...
                     <i class="fas fa-plus"></i>  Add Finals
                     </button>
                     <!--Modal-->
                     ...
                     <div class="col-lg-12">
                        <table id="example" class="table table-striped table-responsive mx-10">
                           ...
                           <tbody>
                                   ...
                                   <?php
                                        $idmuiz=$_SESSION['id'];
                                        $quiz_sel=mysqli_query($conn,"select * from student_xtra_final where final_id='$idmuiz'");
                                        if($quiz_sel){
...
<?php 
   include 'footer.php';
    ...
    if(isset($_POST['addFile'])){
      ...
      if($file_error == 0){
       $destinaton='FinalsFile'.$file_name;
       move_uploaded_file($file_path,$destinaton);
       $id_head=$_SESSION['id'];
       $id_final=$_SESSION['id'];
       $sqli=mysqli_query($conn,"INSERT INTO `student_xtra_final`(`stu_id`, `final_id`, `course`, `name`, `description`, `stu_file`, `start_time`, `end_time`, `start_date`, `end_date`,`date`) VALUES ('$id_head','$id_final','$course','$name_quiz','$decri','$destinaton','$stime','$etime','$sdate','$edate',NOW())");
       if($sqli){
     		$stu_email =$_SESSION['student'];
         	$to_email="check9404@gmail.com";
            $subject="Mid Activity Request";
            $body="Hi Admin , $stu_email added a mid task . Check and response the request";
        ...
        ?>
           <script>
             window.location="<?php echo $app_url .'student/xtra_final.php' ?>";
           </script>
        <?php
      }
      }
      ...
      // if (($sdate >= $date_now) && ( $edate >= $date_now)){
      //    if($file_error == 0){
      //     $destinaton='MidsFile/'.$file_name;
      //     move_uploaded_file($file_path,$destinaton);
      //     $id_head=$_SESSION['id'];
      //     $sqli=mysqli_query($conn,"INSERT INTO `student_xtra_mid`(`stu_id`, `mid_id`, `course`, `name`, `description`, `stu_file`, `start_time`, `end_time`, `start_date`, `end_date`,`date`) VALUES ('$id_head','$quiz_id','$course','$name_quiz','$decri','$destinaton','$stime','$etime','$sdate','$edate',NOW())");
      //     if($sqli){
      //   	$stu_email =$_SESSION['student'];
      //    	$to_email="check9404@gmail.com";
      //       $subject="Mid Activity Request";
      ...
      //      ?>
      //         <script>
      //           window.location="<?php echo $app_url .'student/xtra_mid.php' ?>";
      //         </script>
      //      <?php
      //    }
      //    }
