                  ...
                  <div class="row">
                     <div class="col-lg-12">
                        <table id="example" class="table table-striped table-responsive mx-10">
                           ...
                           <?php
                                         $idt=$_GET['idfinal'];
                                        $quiz_sel=mysqli_query($conn,"select * from teacher_xtra_final where stu_id='$idt'");
                     ...
                     <form method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group" >
                           ...
                           <div class="form-group">
                              ...
                              <textarea name="decri" class="form-control"></textarea>
...
<?php 
   ...
   if(isset($_POST['addFile'])){
    ...
    if($file_error == 0){
     $destinaton='TeacherFinalFile/'.$file_name;
     ...
     $quiz_id=$_GET['final'];
     $file_id=$_GET['fid'];
    $sql=mysqli_query($conn,"INSERT INTO `teacher_xtra_final`(`x_id`,`final_id`,`stu_id`,`teacher_id` ,`name`, `description`, `stu_file`, `course`) VALUES ('$file_id','$quiz_id','$idt','$teacher','$name','$description','$destinaton','$courseStudent')");
    ...
    if($sql){   
      ...
      //       $subject="Lab Task";
      //       $body="Hi Admin , $t_email added a final task ..Check and response the request";
      //       $header="From: $t_email";
      ...
      ?>
         <script>
           window.location="<?php echo $app_url .'teacher/finals.php?id='."$teacher" ?>";
         </script>
      <?php
    }
  }
