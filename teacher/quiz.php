                     ...
                     <div class="col-lg-12">
                        <table id="example" class="table table-striped table-responsive mx-10">
                           ...
                           <tbody>
                             <?php
                              $t_id=$_SESSION['id'];
                                $sql=mysqli_query($conn,"select * from teacher_quiz where teacher_id='$id'");
                                while($rows=mysqli_fetch_assoc($sql)){
                                 ...
                                 <td>
                                 <a href="teacher_xtra_quiz.php?idtq=<?php echo $rows['stu_id']; ?>&idq=<?php echo $t_id;?>&quiz=<?php echo $quiz;?>&fid=<?php echo $qf_id;?>&id=<?php echo $rows['id']; ?>" class="btn btn-success btn-sm editbtn">
                                              Add 
                                       </a>
                                 </td>
                              </tr>
