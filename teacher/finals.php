                     ...
                     <div class="col-lg-12">
                        <table id="example" class="table table-striped table-responsive mx-10">
                           ...
                           <tbody>
                             <?php
                              $t_id=$_SESSION['id'];
                                $sql=mysqli_query($conn,"select * from teacher_finals where teacher_id='$id'");
                                while($rows=mysqli_fetch_assoc($sql)){
                                 ...
                                 <td><a href="../teacher/<?php echo $rows['stu_file']; ?>" download class="btn btn-success btn-sm">File </a></td>
                                 <td>
                                 <a href="teacher_xtra_final.php?idfinal=<?php echo $rows['stu_id']; ?>&id=<?php echo $t_id;?>&final=<?php echo $quiz;?>&fid=<?php echo $qf_id;?>" class="btn btn-success btn-sm editbtn">
                                              Add 
                                       </a>
                                 </td>
                              </tr>
