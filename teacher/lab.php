                     ...
                     <div class="col-lg-12">
                        <table id="example" class="table table-striped table-responsive mx-10">
                           ...
                           <tbody>
                             <?php
                              $t_id=$_SESSION['id'];
                                $sql=mysqli_query($conn,"select * from teacher_lab where teacher_id='$id'");
                                while($rows=mysqli_fetch_assoc($sql)){
                                 ...
                                 <td>
                                 <a href="teacher_xtra_lab.php?idtlb=<?php echo $rows['stu_id']; ?>&id=<?php echo $t_id;?>&lab=<?php echo $quiz;?>&fid=<?php echo $qf_id;?>" class="btn btn-success btn-sm editbtn">
                                              Add 
                                       </a>
                                 </td>
                              </tr>
                           ...
                           <table class="table table-striped">
                              ...
                              <tbody>
                                 <tr>
                                    ...
                                    <td>----------</td>
                                    <td>
                                       <button type="button" class="btn" id="button-addon2" data-bs-toggle="modal" data-bs-target="#myModalDelete">
                                          <i class="fas fa-trash-alt"></i>      Delete</li>
                                    </td>
                                 </tr>
                                 <tr>
                                 <td>Filename</td>
                                 <td>----------</td>
                                 <td>
                                 <button type="button" class="btn" id="button-addon2" data-bs-toggle="modal" data-bs-target="#myModalDelete"><i class="fas fa-trash-alt"></i>      Delete</li>
                                 </td>
                                 </tr>
                                 <tr>
                                 <td>Filename</td>
