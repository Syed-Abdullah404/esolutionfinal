...
<?php 
   if(isset($_POST['save']))
   {
     ...
     $sql=mysqli_query($conn,"INSERT INTO `teacher_assignment_response`(`x_id`, `ass_id`, `stu_id`, `teacher_id`, `name`, `description`, `stu_file`, `course`) VALUES ('$qfid','$quizid','$stid','$teacher','$name','$description','$file','$course')");
     if($sql){
      mysqli_query($conn,"UPDATE `teacher_xtra_assignment` SET `status`='approve' WHERE id='$id'");
        ...
        $temail=mysqli_query($conn,"SELECT * FROM `admin_teacher` WHERE id='$teacher'");
            ...
            $subject="Assignment Task Response";
            $body=" Hi Student, Check your Assignment Task Response..";
            $header="From: check9404@gmail.com ";
         ...
         ?>
         <script>
           window.location="<?php echo $app_url .'admin/assignmentTeacherTab.php' ?>";
         </script>
      <?php
     }
   }
     ...
     if(isset($_POST['reject'])){
      ...
      $xid=$_POST['id'];
       $tidd=$_POST['tidd'];
     $update= mysqli_query($conn,"UPDATE `teacher_xtra_assignment` SET `status`='reject' WHERE id='$iid' ");
     if($update){
        $sremail=mysqli_query($conn,"SELECT * FROM `admin_teacher` WHERE id='$tidd'");
            ...
            $body=" Hi Teacher , Admin Reject your Assignment Request..";
            $header="From: check9404@gmail.com";
