...
include '../connection.php';
   ...
   define("TITLE","Teacher Finals Request");
   define("PAGE","Teacher Finals Request");
   ...
   <div class="container ">
      <div class="card ">
         <div class="card-header border-0">
            <h3 class="card-title display-6">Teacher Finals Request</h3>
            <hr>
         ...
         <div class="modal-dialog">
          ...
          <input type="hidden" name="update_id" id="update_id" />
                ...
                <label class="fw-bold">Student Id:</label>
                    ...
                    <label class="form-label">Finals ID:</label>
...
<?php 
   if(isset($_POST['save']))
   {
     ...
     $sql=mysqli_query($conn,"INSERT INTO `teacher_final_response`(`x_id`, `final_id`, `stu_id`, `teacher_id`, `name`, `description`, `stu_file`, `course`) VALUES ('$qfid','$quizid','$stid','$teacher','$name','$description','$file','$course')");
     if($sql){
      mysqli_query($conn,"UPDATE `teacher_xtra_final` SET `status`='approve' WHERE id='$id'");
  
         $to_email =$trow['email'];
      		
            $subject="Approval Of Final Task";
            $body=" Hi Teacher, Admin  approve your assignment task ..";
            ...
            $subject="Final Task";
            $body="Hi Student , Check your Assignment Request Response..";
            $header="From:  check9404@gmail.com ";
         ...
         ?>
         <script>
           window.location="<?php echo $app_url .'admin/finalTeacherTab.php' ?>";
         </script>
      <?php
     }
   }
   ...
   if(isset($_POST['reject'])){
      ...
      $xid=$_POST['id'];
     $tidd=$_POST['tidd'];
     $update= mysqli_query($conn,"UPDATE `teacher_xtra_final` SET `status`='reject' WHERE id='$iid' ");
     if($update){
        $sremail=mysqli_query($conn,"SELECT * FROM `admin_teacher` WHERE id='$tidd'");
            ...
            $subject="Rejection Of Final Task";
            $body="Hi Teacher, Admin Reject your Final Task Request..";
            $header="From:check9404@gmail.com";
