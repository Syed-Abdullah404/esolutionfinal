...
define("TITLE","Student Project Report");
define("PAGE","Student Project Report");
...
<div class="container ">
         <div class="card ">
              <div class="card-header border-0">
                <h3 class="card-title display-6">Student Project Report</h3>
                <hr>
...
<?php
 if(isset($_REQUEST['searchsubmit'])){
    ...
    $sql = "SELECT * FROM student_xtra_project WHERE date BETWEEN '$startdate' AND '$enddate' AND stu_id='$name'";
