<?php 
   ...
   include '../connection.php';
    $teacher_id=$_GET['id'];
    $sql=mysqli_query($conn,"select * from admin_student where id='$teacher_id'");
               ...
               <div class="card">
                  <div class="row m-3">
                     ...
                     <div class="col-lg-5">
                        ...
                        <h6 >Courses: </h6>
                        <?php
                          $sql_course=mysqli_query($conn,"select * from admin_student_course where student_name='$name'");
                                 ...
                                 <div class="row mt-5">
                                    <div class="col-lg-12">
                                       <table class="example" class="table table-striped table-bordered  mx-10">
                                          ...
                                          <?php
                                            $id=$_GET['id'];
                                              $sql_mid=mysqli_query($conn,"select * from student_xtra_mid where stu_id='$id'");
                                    ...
                                    <div class="col-lg-12">
                                       <table class="example" class="table table-striped table-bordered  mx-10">
                                          ...
                                          <tbody>
                                            <?php
                                            $id=$_GET['id'];
                                              $sql_ass=mysqli_query($conn,"select * from student_xtra_assignment where stu_id='$id'");
                                 ...
                                 <div class="row mt-5">
                                    <div class="col-lg-12">
                                       <table class="example" class="table table-striped table-bordered  mx-10">
                                          ...
                                          <?php
                                            $id=$_GET['id'];
                                              $sql_quiz=mysqli_query($conn,"select * from student_xtra_quiz where stu_id='$id'");
                                    ...
                                    <div class="col-lg-12">
                                       <table class="example" class="table table-striped table-bordered  mx-10">
                                          ...
                                          <tbody>
                                            <?php
                                            $id=$_GET['id'];
                                              $sql_final=mysqli_query($conn,"select * from student_xtra_final where stu_id='$id'");
                                 ...
                                 <div class="row mt-5">
                                    <div class="col-lg-12">
                                       <table class="example" class="table table-striped table-bordered  mx-10">
                                          ...
                                          <?php
                                            $id=$_GET['id'];
                                              $sql_lab=mysqli_query($conn,"select * from student_xtra_lab where stu_id='$id'");
                                 ...
                                 <div class="row mt-5">
                                    <div class="col-lg-12">
                                       <table class="example" class="table table-striped table-bordered  mx-10">
                                          ...
                                          <?php
                                            $id=$_GET['id'];
                                              $sql_project=mysqli_query($conn,"select * from student_xtra_project where stu_id='$id'");
                                 ...
                                 <div class="row mt-5">
                                    <div class="col-lg-12">
                                       <table class="example" class="table table-striped  mx-10">
                                          ...
                                          <?php
                                            $id=$_GET['id'];
                                            $sqlt=mysqli_query($conn,"select * from admin_student where id='$id'");
                                            $rowt=mysqli_fetch_assoc($sqlt);
                                            $tname=$rowt['name'];

                                              $sql_project=mysqli_query($conn,"select * from student_payment where name='$tname'");
                                              while($row_project=mysqli_fetch_assoc($sql_project)){
                                                ?>
                                            <tr>
                                                <td><?php echo $row_project['id']; ?></td>
