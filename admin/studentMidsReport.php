...
define("TITLE","Student Mids Report");
define("PAGE","Student Mids Report");
...
<?php
 if(isset($_REQUEST['searchsubmit'])){
    ...
    $sql = "SELECT * FROM student_xtra_mid WHERE date BETWEEN '$startdate' AND '$enddate' AND stu_id='$name'";
