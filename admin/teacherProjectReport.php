...
define("TITLE","Teacher Project Report");
define("PAGE","Teacher Project Report");
...
<div class="container ">
         <div class="card ">
              <div class="card-header border-0">
                <h3 class="card-title display-6">Teacher Project Report</h3>
                <hr>
...
<?php
 if(isset($_REQUEST['searchsubmit'])){
    ...
    $sql = "SELECT * FROM teacher_project WHERE date BETWEEN '$startdate' AND '$enddate' AND teacher_id='$name'";
