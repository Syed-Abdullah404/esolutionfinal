...
define("TITLE","Teacher Assignment Report");
define("PAGE","Teacher Assignment Report");
...
<div class="container ">
         <div class="card ">
              <div class="card-header border-0">
                <h3 class="card-title display-6">Teacher Assignment Report</h3>
                <hr>
    ...
    <div class="form-row">
        <div class="form-group">
            <select name="name" id="name" class="form-control">
                ...
                <?php
                $query=mysqli_query($conn,"select * from admin_teacher");
...
<?php
 if(isset($_REQUEST['searchsubmit'])){
    ...
    $sql = "SELECT * FROM teacher_assignment WHERE date BETWEEN '$startdate' AND '$enddate' AND teacher_id='$name'";
