            ...
            <div class="row">
              <div class="col-lg-12">
                <table id="example" class="table table-striped  mb-5">
                  ...
                  <tbody>
                    <?php
                    $query = mysqli_query($conn, "select * from student_sign_up where approval='pending' OR approval='YESLOG'");
                    $i = 1;
            ...
            <div class="row">
              <div class="col-lg-12">
                <table id="example" class="table table-striped  mb-5">
                  ...
                  <tbody>
                    <?php
                    $query = mysqli_query($conn, "select s.id,s.name,s.email,a.id from student_sign_up s JOIN admin_student a on s.email = a.email where approval='pending' OR approval='YESLOG';");
                    $i = 1;
                    while ($row = mysqli_fetch_assoc($query)) {
                      $ids = $row['id'];
