...
include '../connection.php';
   ...
   define("TITLE","Teacher Mids Request");
   define("PAGE","Teacher Mids Request");
   ...
   <div class="container ">
      <div class="card ">
         <div class="card-header border-0">
            <h3 class="card-title display-6">Teacher Mids Request</h3>
            <hr>
               ...
               <div class="row">
                  ...
                  <ul class="nav nav-tabs" id="myTab" role="tablist">
                        ...
                        <li class="nav-item" role="presentation">
                            <button class="nav-link" id="profile-tab" data-bs-toggle="tab" data-bs-target="#profile" type="button" role="tab" aria-controls="profile" aria-selected="false">Mids</button>
                        </li>
         ...
         <div class="modal-dialog">
          ...
          <input type="hidden" name="update_id" id="update_id" />
                ...
                <label class="fw-bold">Student Id:</label>
                    ...
                    <label class="form-label">Mid ID:</label>
...
<?php 
   if(isset($_POST['save']))
   {
     ...
     $sql=mysqli_query($conn,"INSERT INTO `teacher_mid_response`(`x_id`, `mid_id`, `stu_id`, `teacher_id`, `name`, `description`, `stu_file`, `course`) VALUES ('$qfid','$quizid','$stid','$teacher','$name','$description','$file','$course')");
     if($sql){
      mysqli_query($conn,"UPDATE `teacher_xtra_mid` SET `status`='approve' WHERE id='$id'");
       $temail=mysqli_query($conn,"SELECT * FROM `admin_teacher` WHERE id='$teacher'");
            ...
            $subject="Approval Of Mids Task";
            $body=" Hi Teacher, admin  approve your Mids task ..";
            ...
            $subject="Mids Task";
            $body="Hi Student, Check  your Mids Request Response..";
            $header="From: check9404@gmail.com";
         ...
         ?>
         <script>
           window.location="<?php echo $app_url .'admin/midTeacherTab.php' ?>";
         </script>
      <?php
     }
   }
   ...
   if(isset($_POST['reject'])){
      ...
      $xid=$_POST['id'];
     $tidd=$_POST['tidd'];
     $update= mysqli_query($conn,"UPDATE `teacher_xtra_mid` SET `status`='reject' WHERE id='$iid' ");
     if($update){
       $sremail=mysqli_query($conn,"SELECT * FROM `admin_teacher` WHERE id='$tidd'");
            ...
            $body="Hi Teacher, Admin Reject your MIDS Request..";
            $header="From: check9404@gmail.com";
