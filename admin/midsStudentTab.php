...
define("TITLE", "Student Mids Request");
define("PAGE", "Student Mids Request");
   ...
   <div class="container ">
      <div class="card ">
         <div class="card-header border-0">
            <h3 class="card-title display-6">Student Mids Request</h3>
            <hr>
                        ...
                        <td>
                           ...
                           <div class="action">
                              ...
                              <ul class="dropdown-menu p-0">
                                 ...
                                 <li class="dropdown-item fee"  data-bs-toggle="modal" data-bs-target="#myModalFee"><i class="fal fa-credit-card"></i> Fee</li>
         ...
         <div class="modal-body">
            <form method="POST" enctype="multipart/form-data">
               ...
               <div class="form-group">
                  ...
                  <label class="fw-bold">Mids Id:</label>
...
if (isset($_POST['save'])) {
   ...
   if (($sdate >= $date_now) && ($edate >= $date_now)) {
      $sql = mysqli_query($conn, "INSERT INTO `teacher_mids`(`x_id`,`mid_id`, `stu_id`,`teacher_id`, `name`, `description`, `stu_file`, `course`, `start_time`, `end_time`, `start_date`, `end_date`,`date`) VALUES ('$xid','$qtid','$stid','$teacher','$name','$description','$file','$course','$stime','$etime','$sdate','$edate',NOW())");
      if ($sql) {
         mysqli_query($conn, "UPDATE `student_xtra_mid` SET `status`='apporve' WHERE mid_id='$qtid' AND id='$xid'");
         ...
         $subject = "Assigning Of Mid Task";
         $body = " Hi Teacher, admin  assign a mids task to you Check Your Portal..";
         ...
         $to_email = $srow['email'];
         $subject = "Approval Of Assignment Task";
...
?>
         <script>
            window.location = "<?php echo $app_url . 'admin/midsStudentTab.php' ?>";
         </script>
      <?php
      }
   } else {
...
if (isset($_POST['reject'])) {
   ...
   $xid = $_POST['id'];
   $sttid = $_POST['sttid'];
   $update = mysqli_query($conn, "UPDATE `student_xtra_mid` SET `status`='reject' WHERE mid_id='$qtid' AND id='$xid'");
   if ($update) {
      ...
      $subject = "Rejection Of Mids Task";
      $body = "Hi Student , Admin Reject your Mid Request Check your Portal..";
      $header = "From: check9404@gmail.com";
...
$mid_id = $_POST['assignment_id'];
$fee_student = $_POST['fee_student'];
mysqli_query($conn, "UPDATE `student_xtra_mid` SET `fee`='$fee_student' WHERE mid_id='$mid_id' AND id='$id'");
