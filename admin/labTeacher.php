...
<?php 
   if(isset($_POST['save']))
   {
     ...
     $sql=mysqli_query($conn,"INSERT INTO `teacher_lab_response`(`x_id`, `lab_id`, `stu_id`, `teacher_id`, `name`, `description`, `stu_file`, `course`) VALUES ('$qfid','$quizid','$stid','$teacher','$name','$description','$file','$course')");
     if($sql){
      mysqli_query($conn,"UPDATE `teacher_xtra_lab` SET `status`='approve' WHERE id='$id'");
       $temail=mysqli_query($conn,"SELECT * FROM `admin_teacher` WHERE id='$teacher'");
            ...
            $body="Hi Teacher, admin  approve your lab task request..";
            ...
            $subject="LAB Task";
            $body=" Hi Student, Check your LAB task Request Response..";
            $header="From: check9404@gmail.com";
         ...
         ?>
         <script>
           window.location="<?php echo $app_url .'admin/labTeacherTab.php' ?>";
         </script>
      <?php
     }
   }
    ...
    if(isset($_POST['reject'])){
      ...
      $xid=$_POST['id'];
      $tidd=$_POST['tidd'];
     $update= mysqli_query($conn,"UPDATE `teacher_xtra_lab` SET `status`='reject' WHERE id='$iid' ");
     if($update){
        $sremail=mysqli_query($conn,"SELECT * FROM `admin_teacher` WHERE id='$tidd'");
            ...
            $body="Hi Teacher , Admin Reject your LAB TASK Request Check your Portal ..";
            $header="From: check9404@gmail.com";
