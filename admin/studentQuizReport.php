...
define("TITLE","Student Quiz Report");
define("PAGE","Student Quiz Report");
...
<div class="container ">
         <div class="card ">
              <div class="card-header border-0">
                <h3 class="card-title display-6">Student Quiz Report</h3>
                <hr>
...
<?php
 if(isset($_REQUEST['searchsubmit'])){
    ...
    $sql = "SELECT * FROM student_xtra_quiz WHERE date BETWEEN '$startdate' AND '$enddate' AND stu_id='$name'";
