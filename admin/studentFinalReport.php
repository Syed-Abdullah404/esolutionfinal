...
define("TITLE","Student Final Report");
define("PAGE","Student Final Report");
...
<div class="container ">
         <div class="card ">
              <div class="card-header border-0">
                <h3 class="card-title display-6">Student Final Report</h3>
                <hr>
...
<?php
 if(isset($_REQUEST['searchsubmit'])){
    ...
    $sql = "SELECT * FROM student_xtra_final WHERE date BETWEEN '$startdate' AND '$enddate' AND stu_id='$name'";
